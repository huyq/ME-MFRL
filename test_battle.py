...
if __name__ == '__main__':
    ...
    parser.add_argument('--algo', type=str, choices={'attention_mfq', 'mfq', 'il', 'me_mfq'}, help='choose an algorithm from the preset', required=True)
    parser.add_argument('--oppo', type=str, choices={'attention_mfq', 'mfq', 'il', 'me_mfq'}, help='indicate the opponent model')
    ...
    # main_model_dir = os.path.join(BASE_DIR, 'data/models/{}_{}-0'.format(args.algo, args.seed[0]))
    # oppo_model_dir = os.path.join(BASE_DIR, 'data/models/{}_{}-1'.format(args.oppo, args.seed[1]))
