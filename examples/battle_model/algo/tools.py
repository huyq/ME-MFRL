...
class Runner(object):
    def __init__(self, sess, env, handles, map_size, max_steps, models,
                ...
                log_name=None, log_dir=None, model_dir=None, seed=0, train=False):
        """Initialize runner
        ...
        if self.train:
            ...
            algo = models[0].name.split('-')[0]
            self.log_dir = f'data/logs/battle_{algo}_{seed}.csv'
            # with open(self.log_dir, 'w+') as myfile:
                # myfile.write('{0},{1}\n'.format("Episode", "sumofrewards"))
    ...
    def run(self, variant_eps, iteration, win_cnt=None):
        ...
        if self.train:
            ...
            # with open(self.log_dir, 'a') as myfile:
                # myfile.write('{0},{1}\n'.format(iteration, total_rewards[0]))
